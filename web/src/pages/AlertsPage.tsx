...
export function AlertsPage() {
  ...
  const resource = useResource(useCallback((signal: AbortSignal) => api<Alerts>(readPath(demo, "alerts"), { signal }), [demo]), [demo]);

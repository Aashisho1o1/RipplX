...
export function FilingPage() {
  ...
  return <main className="page">
    {detail.sample_data && <div className="notice neutral">Public SEC showcase · every displayed quotation is checked against the stored canonical section identified by its offsets and content hash.</div>}

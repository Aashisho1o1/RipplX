...
export function FilingPage() {
  ...
  return <main className="page">
    {detail.sample_data && <div className="notice neutral">Sample data · this filing is an abridged bundled excerpt, so the character offsets and section hash below are exact against that excerpt rather than the full document on EDGAR.</div>}

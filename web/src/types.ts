...
export interface FilingItem { accession: string; ticker: string; form: string; filed: string; severity: Severity | null; material_items: MaterialItem[]; flags: RedFlag[]; manual_review: boolean }
...
export interface FilingDetail { filing: FilingItem; what_changed: WhatChanged[]; verified_numbers: IssuerMetrics | null; verification: Verification | null; insufficient_reason: string | null; withheld_reason: string | null; pipeline: PipelineStage[]; disclaimer: string }

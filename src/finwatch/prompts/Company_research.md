...
4. `{"action":"tool","tool":"get_valuation_context","arguments":{}}`
5. `{"action":"tool","tool":"get_peer_context","arguments":{}}`
6. `{"action":"submit","draft":{"summary":"...","insights":[...]}}`

The six obligations in the input are mandatory. Retrieve the smallest useful evidence
...
`insight_id` (i1-i5), `category` (business|change|financial_quality|valuation|peer),
...
dilution|discount_rate|uncertain), `implication`, `scenario`
